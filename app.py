...
def remove_task():
    task_index_str = request.args.get('deltaskid')
    if not task_index_str:
        return render_template('home.html',datetoday2=datetoday2,tasklist=gettasklist(),l=len(gettasklist()),mess='Please enter a task index...') 
